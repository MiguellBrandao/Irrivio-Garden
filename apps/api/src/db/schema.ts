...
export const gardens = pgTable('gardens', {
  ...
  isRegularService: boolean('is_regular_service').default(true).notNull(),
  showInCalendar: boolean('show_in_calendar').default(true).notNull(),
  maintenanceFrequency: varchar('maintenance_frequency', { length: 50 }),
  maintenanceDayOfWeek: varchar('maintenance_day_of_week', { length: 20 }),
  maintenanceAnchorDate: date('maintenance_anchor_date'),
  maintenanceStartTime: time('maintenance_start_time'),
